...
exports.sampleOutput = exports.sampleInput = exports.sampleOutputScyllaLuck15 = void 0;
const interfaces_1 = require("./interfaces");
const InputPromptGeneration_1 = require("./InputPromptGeneration");
const charybdis_scylla_json_1 = __importDefault(require("../../../../chatbot/src/NodeData/charybdis_scylla.json"));
/* [
    Others Opinions,
...
// time:number;
// numCrew:number;
const sampleOutputScyllaLuck15 = (numCrewBefore, peopleOfInterest) => {
    const st = `
    {
...
exports.sampleOutputScyllaLuck15 = sampleOutputScyllaLuck15;
//now lets generate an example to put into the prompt
charybdis_scylla_json_1.default.components = charybdis_scylla_json_1.default.components.map((c) => {
...
const luck = 15;
exports.sampleInput = (0, InputPromptGeneration_1.generateInput)(othersOpinions, currentScores, new interfaces_1.MyNode(charybdis_scylla_json_1.default.entranceDescription, charybdis_scylla_json_1.default.components, charybdis_scylla_json_1.default.primarySourceText, charybdis_scylla_json_1.default.specialInstructions, charybdis_scylla_json_1.default.citation), recentChatHistory, infoToPass, luck);
// console.log(sampleInput)
exports.sampleOutput = (0, exports.sampleOutputScyllaLuck15)(numCrew, othersOpinions);
