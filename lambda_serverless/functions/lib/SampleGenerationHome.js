...
exports.sampleOutputHome = exports.sampleInputHome = exports.sampleOutputHomeLuck12 = void 0;
const interfaces_1 = require("./interfaces");
const InputPromptGeneration_1 = require("./InputPromptGeneration");
const home_json_1 = __importDefault(require("../../../../chatbot/src/NodeData/home.json"));
/* [
    Others Opinions,
...
// time:number;
// numCrew:number;
const sampleOutputHomeLuck12 = (numCrewBefore, peopleOfInterest) => {
    const st = `
    {
...
exports.sampleOutputHomeLuck12 = sampleOutputHomeLuck12;
//now lets generate an example to put into the prompt
home_json_1.default.components = home_json_1.default.components.map((c) => {
...
const recentChatHistory = [
    {
        message: home_json_1.default.entranceDescription,
        sender: "bot"
    },
    {
...
const luck = 12;
exports.sampleInputHome = (0, InputPromptGeneration_1.generateHomeInput)(othersOpinions, currentScores, new interfaces_1.MyNode(home_json_1.default.entranceDescription, home_json_1.default.components, home_json_1.default.primarySourceText, home_json_1.default.specialInstructions, home_json_1.default.citation), recentChatHistory, infoToPass, luck, 30);
// console.log(sampleInput)
exports.sampleOutputHome = (0, exports.sampleOutputHomeLuck12)(numCrew, othersOpinions);
